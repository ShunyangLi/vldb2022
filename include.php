...
if (file_exists($page)) {
    ...
    header('X-Page-Title: '.(defined('PageTitle') && PageTitle ? PageTitle : "48th International Conference on Very Large Data Bases"));
    /*
    ...
    */
    ...
    header('X-Page-Title: 48th International Conference on Very Large Data Bases');
