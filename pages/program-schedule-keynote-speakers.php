<section class="program-schedule-keynote-speakers">
    <h1>VLDB 2022: Keynote Speakers</h1>
    ...
    <!-- <div class="schedule-wrap">
        ...
        <div>
            ...
            <p class="schedule-item schedule-item-has-photo">
                ...
                <strong class="schedule-item-title">Getting Rid of Data</strong>
                <span class="schedule-item-people">
                    <span class="author">Tova Milo</span> (Tel Aviv University, Israel)
                </span>
                <a href="https://vldb2022.github.io/files/VLDB19-keynote-2-slides.pdf" class="slides">Slides</a>
                <span class="schedule-item-abstract">
                    <a class="schedule-item-action"></a>
                    <strong class="schedule-part-label">Abstract:</strong>
        ...
        <div>
            ...
            <p class="schedule-item schedule-item-has-photo">
                ...
                <strong class="schedule-item-title">Awesome Data Use Cases from Hollywood: How data is changing everything about the entertainment experience</strong>
                <span class="schedule-item-people">
                    <span class="author">Eric Iverson</span> (CIO, Creative Artists Agency)
                </span>
                <span class="schedule-item-abstract">
                    <a class="schedule-item-action"></a>
                    <strong class="schedule-part-label">Abstract:</strong>
...
<script type="application/ld+json">
{
  ...
  "url": "https://vldb.org/2022/?program-schedule-keynote-speakers",
  ...
  "breadcrumb": {
    ...
    "itemListElement": [{
      ...
      "position": 5,
      "item": {
        "@id": "https://vldb.org/2022/?program-schedule-keynote-speakers",
        "name": "Keynote Speakers"
      }
    }]
  }
