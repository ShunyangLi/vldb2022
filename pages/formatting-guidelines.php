<section class="formatting-guidelines">
    <h1>VLDB 2022: Formatting Guidelines</h1>
    <h3>Research papers</h3>
    <p>VLDB 2022 expects
        <strong>all submitted research papers to follow the official PVLDB Formatting Guidelines</strong>,
        as detailed at the official website:</p>
	  <p><a href="http://vldb.org/pvldb/vol15-formatting/">http://vldb.org/pvldb/vol15-formatting/</a></p>
    ...
    <ul>
        ...
        <li>contain the same author information as in <a href="https://cmt3.research.microsoft.com/VLDB2022/">CMT</a>. e.g., the order of the authors must be the same in the
            paper and <a href="https://cmt3.research.microsoft.com/VLDB2022/">CMT</a>. Middle names of the authors, if any, must be the same as it is in <a href="https://cmt3.research.microsoft.com/VLDB2022/">CMT</a>.
        </li>
        <li>contain no citations in the Abstract.</li>
        <li>contain the same Abstract as the one submitted to <a href="https://cmt3.research.microsoft.com/VLDB2022/">CMT</a>.</li>
    </ul>
    ...
    <ul>
        <li>For research track papers that belong to a special category (Vision, Innovative Systems and Applications,
            ...
            <a href="https://cmt3.research.microsoft.com/VLDB2022/">CMT</a> submission title.
        </li>
    ...
    <ol>
        ...
        <li>Submit the final version of your paper as PDF using the VLDB 2022 conference management tool that is accessible at https://cmt3.research.microsoft.com/VLDB2022/.</li>
        <li>In <a href="https://cmt3.research.microsoft.com/VLDB2022/">CMT</a>, please check carefully the paper's meta-data such as title, abstract, authors' names, affiliations, and their order, and correct those if necessary; note that this information, once processed, will be final and used for producing the conference booklet.</li>
        <li>Rename your file to pid-contact-author.lastname.pdf and upload it to <a href="https://cmt3.research.microsoft.com/VLDB2022/">CMT</a>; for instance, if your submission was given the id 42 and your name is John Smith, you should name your file p42-smith.pdf.</li>
...
define('PageDescription', "All papers submitted to PVLDB and the VLDB 2022 Conference, irrespective of track, must adhere strictly to the PVLDB format detailed here.");
?>
<script type="application/ld+json">
{
  ...
  "url": "https://vldb.org/2022/?formatting-guidelines",
  "description": "All papers submitted to PVLDB and the VLDB 2022 Conference, irrespective of track, must adhere strictly to the PVLDB format detailed here.",
  "breadcrumb": {
    "@type": "BreadcrumbList",
    "itemListElement": [{
      "@type": "ListItem",
      ...
      "position": 5,
      "item": {
        "@id": "https://vldb.org/2022/?formatting-guidelines",
        "name": "Formatting Guidelines"
      }
    }]
  }
